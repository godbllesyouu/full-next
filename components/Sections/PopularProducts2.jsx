...
export default function PopulaProducts2() {
    const [activeButton, setActiveButton] = useState(null)
    const [activeButtonn, setActiveButtonn] = useState(null)
    return (
        <div>
            <section className="w-full h-[600px]  bg-white flex flex-col justify-center ">
                <div className="flex gap-[800px] h-[40px] justify-center items-center ">
                    <div className="flex text-left">
                        <span className="text-[26px] font-bold ">Новинки</span>
                    </div>
                ...
                <div className="flex justify-center mt-[24px] gap-[30px] ">
                    <div className="w-[270px] h-[400px] px-[8px] py-[8px] flex flex-col gap-[31px] rounded-[5px]">
                        ...
                        <div className="flex flex-col gap-[12px]  ">
                            ...
                            <button className="w-[255px] h-[36px]  cursor-pointer rounded-[4px] font-bold text-black rounded-[4px] transition duration-[0.3s]  font-bold border border-[rgba(0,160,172,1)] hover:bg-[rgba(0,160,172,1)] hover:text-white"><p>Купить в 1 клик</p></button>
                        </div>
                    </div>
                    <div className="w-[270px] h-[400px] bg-white px-[8px] py-[8px] flex flex-col gap-[16px] rounded-[5px]">
                        ...
                        <div className="flex flex-col gap-[12px]  ">
                            ...
                            <button className="w-[255px] h-[36px] rounded-[4px] font-bold cursor-pointer text-black rounded-[4px]  transition duration-[0.3s] font-bold border border-[rgba(0,160,172,1)] hover:bg-[rgba(0,160,172,1)] hover:text-white"><p>Купить в 1 клик</p></button>
                        </div>
                    </div>
                    <div className="w-[270px] h-[400px] bg-white px-[8px] py-[8px] flex flex-col gap-[31px] rounded-[5px]">
                        ...
                        <div className="flex flex-col gap-[12px]  ">
                            ...
                            <button className="w-[255px] h-[36px] font-bold rounded-[4px] font-bold cursor-pointer  text-black rounded-[4px] transition duration-[0.3s]  border border-[rgba(0,160,172,1)] hover:bg-[rgba(0,160,172,1)] hover:text-white"><p>Купить в 1 клик</p></button>
                        </div>
                    </div>
                    <div className="w-[270px] h-[400px] bg-white px-[8px] py-[8px] flex flex-col gap-[31px] rounded-[5px]">
                        <div className="flex flex-col gap-[16px]">
                        ...
                        <div className="flex flex-col gap-[12px]  ">
                            ...
                            <button className="w-[255px] h-[36px] rounded-[4px]font-bold text-black  transition duration-[0.3s] cursor-pointer rounded-[4px] font-bold border border-[rgba(0,160,172,1)] hover:bg-[rgba(0,160,172,1)]  hover:text-white"><p>Купить в 1 клик</p></button>
                        </div>
                    </div>
                </div>
